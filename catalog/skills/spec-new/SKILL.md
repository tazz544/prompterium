...
name: spec-new
description: >-
  Create a new feature spec under docs/simulations-react/specs/ from the user's
...
Create a new feature spec in `docs/simulations-react/specs/` based on the feature description provided by the user.

1. Derive a short kebab-case feature name and create `docs/simulations-react/specs/<feature-name>/` by copying the structure of `docs/simulations-react/specs/_template/`, or seed from `.cursor/templates/spec.md` and `.cursor/templates/tasks.md` if no project template exists.
